...
trap "rm -f /tmp/cmpi-base.tar.gz ; 
      rm -f /tmp/indication-helper.tar.gz ;
      rm -f /tmp/cmpi-base.tar.gz ;
      rm -f /tmp/cmpi-wbemcli.tar.gz ; 
      rm -f /tmp/cmpi-testsuite.tar.gz " exit 

rm -rf sblim-* testsuite 
rm -f schema/*
cp dummy.mof schema
